...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty runArrow;
    ...
    protected virtual void OnEnable()
    {
        ...
        runArrow = serializedObject.FindProperty("runArrow");
    }
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.ObjectField(runArrow, new GUIContent("runArrow", "The run arrow's RectTransform component."));
    }
}